            ...
            <div className="bg-blue-100 p-4">
                <div className="flex items-center">
                    <img
                        ...
                        src={consumer.profile.profilePicture} // replace with the actual image URL
                        alt="Profile"
                    />
                    <div className="ml-4">
                        <h2 className="text-lg font-semibold text-gray-800">{consumer.profile.fullName}</h2>
                        <p className="text-sm text-gray-600">@{consumer.username}</p>
                    </div>
                </div>
                <p className="mt-4 text-gray-600">{consumer.role}</p>
            </div>
